...
public class WebConnection : MonoBehaviour
{
    ...
    static public int mazeType { private set; get; }
    ...
    {
        string[] records = currentScore.Split("|");
        string[][] levels = 
        {
        ...
        {
            case "Easy":
                levels[mazeType][0] = currentLevel;
                times[mazeType][0] = currentTime;
                break;
            case "Normal":
                levels[mazeType][1] = currentLevel;
                times[mazeType][1] = currentTime;
                break;
            case "Hard":
                levels[mazeType][2] = currentLevel;
                times[mazeType][2] = currentTime;
                break;
        }
        ...
        SetCurrentScore(finalLevel + "|" + finalTime);
    }
